...
//! (ADR-0117). Both stores are written through the internal API — the runner has no direct DB
...
/// the control plane uses it to attach this chunk's vector to that `:Symbol` (ADR-0117). Submit the
