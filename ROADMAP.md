...
- **One walk, and a symbol's vector comes from its own code** — indexing used to run two independent
  ...
  ([ADR-0117](docs/adr/0117-one-walk-node-id-symbol-embeddings.md), #654, #652)
...
- **Symbol-level semantic search for the review agent** — a new `lightbridge_graph_semantic_search`
  ...
  [ADR-0117](docs/adr/0117-one-walk-node-id-symbol-embeddings.md); originally by range containment),
