...
| [0075](0075-rig-for-new-agent-surfaces.md) | Rig (rig-core, pinned) for new agent surfaces only (RFC-0006 agents); the native review loop + transport stay (ADR-0026 scoped, not superseded) — gated on an eaig transport-fidelity spike (thought_signature/reasoning/usage through the OpenAI-compatible path) | Proposed |
