...
| [0061](0061-sast-deterministic-finding-source.md) | SAST (opengrep) as a deterministic finding source — runs in the runner, rides the existing channel (not reviewdog), LLM-aware not LLM-gated | Superseded by ADR-0072 |
